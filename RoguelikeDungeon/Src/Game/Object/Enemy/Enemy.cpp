...
//	//	MV1SetScale(m_Enemyhndl[index], VGet(0.5f, 0.5f, 0.5f));
//	//	MV1SetRotationXYZ(m_Enemyhndl[index], VGet(0.0f, DX_PI_F, 0.0f));
//	//}
//
//}
//
...
//
//void CEnemy::Draw() {
//	int hndl = m_ModelManager->GetModel(static_cast<int>(m_EnemyType));
//
//	if (hndl == -1) {
//		return;
//	}
